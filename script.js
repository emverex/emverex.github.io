                  ...
                  $.getJSON('list.json', function (result) {
                        ...
                        if (searchResult.length > 0) {
                              ...
                              for (i = 0; i < searchResult.length; i++) {
                                    $('#movc').append("<a class='mov' mov-lang=" + searchResult[i].lang + " mov-year=" + searchResult[i].year + " href=" + searchResult[i].play + "><img class='img' src=" + searchResult[i].img + "alt='Movie Poster'><p class='name'>" + searchResult[i].name + "</p></a>")
                              }
                        } else {
                              $('#movc').empty();
                              $('#movt').empty();
